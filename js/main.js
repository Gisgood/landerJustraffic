(function (window, document, $, undefined) {
    ...
    var justrafficJs = {
      ...
      methods: function (e) {
        justrafficJs.smothScroll();
        justrafficJs.counterUpActivation();
        justrafficJs.wowActivation();
        justrafficJs.headerTopActivation();
        justrafficJs.headerSticky();
        justrafficJs.salActive();
        justrafficJs.popupMobileMenu();
        justrafficJs.popupDislikeSection();
        justrafficJs.popupleftdashboard();
        justrafficJs.popuprightdashboard();
        justrafficJs.preloaderInit();
        justrafficJs.showMoreBtn();
        justrafficJs.masonryActivation();
        justrafficJs.magnigyPopup();
        justrafficJs.lightBoxJs();
        justrafficJs.slickSliderActivation();
        justrafficJs.radialProgress();
        justrafficJs.contactForm();
        justrafficJs.menuCurrentLink();
        justrafficJs.onePageNav();
        justrafficJs.darkLight();
        justrafficJs.featherIcons();
        justrafficJs.selectPicker();
      },
      ...
      preloaderInit: function () {
        justrafficJs._window.on("load", function () {
...
function generateAutoReply() {
    return `justraffic: I'm a dynamic chat bot!`;
  }
  ...
  function sendMessage() {
    ...
    if (welcomeMessageIndex < welcomeMessages.length) {
      const welcomeMessageElement = createMessageWithReactions('justraffic', welcomeMessages[welcomeMessageIndex], 'ai-speech', 'assets/images/team/avater.png');
      appendMessage(welcomeMessageElement);
      welcomeMessageIndex++;
    } else {
      const autoReply = generateAutoReply();
      const autoReplyElement = createMessageWithReactions('justraffic', autoReply, 'ai-speech', 'assets/images/team/avater.png');
  ...
  function saveAndRegenerateMessage(button) {
    ...
    const regeneratedMessageElement = createMessageWithReactions('justraffic', regeneratedMessage, 'ai-speech', 'assets/images/team/avater.png');
